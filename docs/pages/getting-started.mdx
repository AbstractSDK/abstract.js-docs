# Get started [Get started with abstract.js with just a few lines of code.]
...
:::warning
Since SDK relies on [ts-codegen](https://github.com/CosmWasm/ts-codegen), it is required to install only the 4th major version of TanStack React Query,
