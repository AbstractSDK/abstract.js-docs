...
:::info
If you are using `graz`, you can skip this step as [graz](https://graz.sh) already provides a `QueryClient` instance which `AbstractProvider` uses. See the [example with graz](./providers/graz.mdx).
:::
